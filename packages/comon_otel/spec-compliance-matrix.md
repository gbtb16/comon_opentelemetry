...
| Feature | Optional | C++ | Dart |
| ------- | -------- | --- | ---- |
| [TracerProvider](specification/trace/api.md#tracerprovider-operations) | Optional | C++ | Dart |
...
| [Trace / Context interaction](specification/trace/api.md#context-interaction) | Optional | C++ | Dart |
| Get active Span |  | + | + |
| Set active Span |  | + | + |
| [Tracer](specification/trace/api.md#tracer-operations) | Optional | C++ | Dart |
| Create a new Span |  | + | + |
| Documentation defines adding attributes at span creation as preferred |  |  | + |
| Get active Span |  | + | + |
| Mark Span active |  | + | + |
| Safe for concurrent calls |  | + | N/A |
| [SpanContext](specification/trace/api.md#spancontext) | Optional | C++ | Dart |
| IsValid |  | + | + |
| IsRemote |  | + | + |
| Conforms to the W3C TraceContext spec |  | + | + |
| [Support W3C Trace Context Level 2 randomness](specification/trace/sdk.md#traceid-randomness) |  |  | - |
| [Span](specification/trace/api.md#span) | Optional | C++ | Dart |
| Create root span |  | + | + |
...
| [Span attributes](specification/trace/api.md#set-attributes) | Optional | C++ | Dart |
| SetAttribute |  | + | + |
...
| [Span linking](specification/trace/api.md#specifying-links) | Optional | C++ | Dart |
| Links can be recorded on span creation |  | + | + |
| Links can be recorded after span creation |  | + | + |
| Links order is preserved |  | + | + |
| [Span events](specification/trace/api.md#add-events) | Optional | C++ | Dart |
| AddEvent |  | + | + |
| Add order preserved |  | + | + |
| Safe for concurrent calls |  | + | N/A |
| [Span exceptions](specification/trace/api.md#record-exception) | Optional | C++ | Dart |
| RecordException |  | - | + |
| RecordException with extra parameters |  | - | + |
| [Sampling](specification/trace/sdk.md#sampling) | Optional | C++ | Dart |
...
| All methods of `MeterProvider` are safe to be called concurrently. |  | + | N/A |
| All methods of `Meter` are safe to be called concurrently. |  | + | N/A |
| All methods of any instrument are safe to be called concurrently. |  | + | N/A |
...
| The metrics Exporter `export` function can not be called concurrently from the same Exporter instance. |  | + | N/A |
...
| **[OTLP](specification/protocol/otlp.md)** | Optional | C++ | Dart |
| OTLP/gRPC Exporter | * | + | + |
...
| **[Zipkin](specification/trace/sdk_exporters/zipkin.md)** | Optional | C++ | Dart |
| Zipkin V1 JSON | X | - | - |
| Zipkin V1 Thrift | X | - | - |
| Zipkin V2 JSON | X | + | - |
