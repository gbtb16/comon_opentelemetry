...
/// OTLP HTTP protobuf exporter for logs.
final class OtlpHttpProtobufLogExporter implements LogExporter {
  /// Creates an OTLP HTTP protobuf log exporter.
  OtlpHttpProtobufLogExporter({
    ...
    return executeOtlpExportWithRetry(
      ...
      send: () => _transport.postBytes(
        OtlpHttpRequest(
          ...
          rawBody: OtlpProtobufCodec.encodeLogs(logs),
          headers: _headers,
          timeout: _timeout,
