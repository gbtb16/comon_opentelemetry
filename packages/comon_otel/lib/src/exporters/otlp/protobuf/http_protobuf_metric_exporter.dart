...
/// OTLP HTTP protobuf exporter for metrics.
final class OtlpHttpProtobufMetricExporter implements MetricExporter {
  /// Creates an OTLP HTTP protobuf metric exporter.
  OtlpHttpProtobufMetricExporter({
    ...
    return executeOtlpExportWithRetry(
      ...
      send: () => _transport.postBytes(
        OtlpHttpRequest(
          ...
          rawBody: OtlpProtobufCodec.encodeMetrics(metrics),
          headers: _headers,
          timeout: _timeout,
