...
/// OTLP HTTP JSON exporter for trace data.
final class OtlpHttpJsonSpanExporter implements SpanExporter {
  /// Creates an OTLP HTTP JSON span exporter.
    ...
    return executeOtlpExportWithRetry(
      ...
      send: () => _transport.postJson(
        OtlpHttpRequest(
          ...
          body: jsonEncode(OtlpJsonCodec.encodeSpans(spans)),
          headers: _headers,
          timeout: _timeout,
